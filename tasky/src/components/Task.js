        ...
        <Card sx={{
            ...
            <CardContent>
                ...
                <Chip 
                   ...
                   color={
                    props.priority === 'Low' ? 'success' : // Green for Low
                    props.priority === 'Medium' ? 'warning' : // Yellow for Medium
                    props.priority === 'High' ? 'error' : 'primary' // Red for High, default to primary
                    }
                />
                </Box>
